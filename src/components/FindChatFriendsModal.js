...
import { getAllUserService, searchUsersService } from "../services/user";
import Profile from "../assets/images/default.png";
import Spinner from "./common/loaders/Spinner";
import Button from "./common/Button";

const FindChatFriendsModal = (props) => {
...
export default FindChatFriendsModal;
